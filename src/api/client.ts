...
export const api = createApi({
  ...
  endpoints: (build) => ({
    ...
    getQubicLIStats: build.query<
      ...
      {
        range: string | null;
        timeline?: "hourly" | "daily" | "weekly" | "minute";
      }
    >({
